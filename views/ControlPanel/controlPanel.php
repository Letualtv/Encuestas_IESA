...
<div class="input-group p-3">
    ...
    <!-- Scripts -->
<script src="/views/ControlPanel/js/agregarEliminar.js"></script>
<script src="/views/ControlPanel/js/jumpRules.js"></script>
<script src="/views/ControlPanel/js/admin_variables.js"></script>
<script src="/views/ControlPanel/js/confBorrarCargPreguntas.js"></script>
<script src="/views/ControlPanel/js/cargarEditarGuardar.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/xlsx.full.min.js"></script>
<script src="https://unpkg.com/jspdf@latest/dist/jspdf.umd.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.25/jspdf.plugin.autotable.min.js"></script>
<script src="/views/ControlPanel/js/exportar.js"></script>
