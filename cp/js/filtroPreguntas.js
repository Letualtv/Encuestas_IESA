...
function agregarFiltro(preguntaId = "", tipoFiltro = "", parametros = "") {
  ...
  ruleDiv.innerHTML = `
    <div class="col d-flex input-group input-group-sm">
        ...
        <input type="text" class="form-control shadow-sm col" value="${preguntaId}" placeholder="Pregunta" required>
        <select class="form-select form-select-sm shadow-sm col" onchange="actualizarParametrosFiltro(this)">
            <option value="unico" ${
              tipoFiltro === "unico" ? "selected" : ""
            }>Igual a</option>
        <option value="rango-arriba" ${
          tipoFiltro === "rango-arriba" ? "selected" : ""
        }>Igual o superior a</option>
        <option value="rango-abajo" ${
          tipoFiltro === "rango-abajo" ? "selected" : ""
        }>Igual o menor a</option>
        <option value="exclusion" ${
          tipoFiltro === "exclusion" ? "selected" : ""
        }>Distinto de</option>
        <option value="rango-cerrado" ${
          tipoFiltro === "rango-cerrado" ? "selected" : ""
        }>Entre 
    </option>
        </select>
        <div class="parametros-filtro d-flex align-items-center col">
...
function eliminarFiltro(button) {
  ...
  document.getElementById("confirmDeleteModalLabel").textContent =
