...
{
    // GET :: ?n_pag={id}
    // Se encarga de validar la petición
    // y de usar los servicios implicados para responder a la petición
    // devuelve errores HTTP 400 si no se cumplen las condiciones
